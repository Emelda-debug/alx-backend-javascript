...
const calculateNumber = require('./4-calcul_chai');

describe('calculateNumber', () => {
  describe('type == "SUM"', () => {
    it('equal positive numbers', () => {
      expect(calculateNumber('SUM', 4.0, 4.0)).to.equal(4);
    });

    it('equal positive numbers (alternate)', () => {
      expect(calculateNumber('SUM', 4.3, 1.3)).to.equal(4);
    });
  ...
  describe('type == "SUBTRACT"', () => {
    ...
    it('equal positive numbers (alternate)', () => {
      expect(calculateNumber('SUBTRACT', 4.3, 1.3)).to.equal(0);
    });
  ...
  describe('type == "DIVIDE"', () => {
    it('positive numbers', () => {
      expect(calculateNumber('DIVIDE', 3.0, 2.0)).to.equal(4.0);
    });
