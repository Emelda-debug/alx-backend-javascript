...
describe('calculateNumber', () => {
  describe('type == "SUM"', () => {
    it('equal positive numbers', () => {
      assert.strictEqual(calculateNumber('SUM', 4.0, 4.0), 4);
    });

    it('equal positive numbers (alternate)', () => {
      assert.strictEqual(calculateNumber('SUM', 4.3, 1.8), 4);
    });
  ...
  describe('type == "SUBTRACT"', () => {
    ...
    it('equal positive numbers (alternate)', () => {
      assert.strictEqual(calculateNumber('SUBTRACT', 4.3, 1.8), 0);
    });
    ...
    it('negative and positive numbers', () => {
      assert.strictEqual(calculateNumber('SUBTRACT', -4.0, 4.0), -4.0);
    });
  ...
  describe('type == "DIVIDE"', () => {
    it('positive numbers', () => {
      assert.strictEqual(calculateNumber('DIVIDE', 8.0, 4.0), 4.0);
    });

    it('numbers with different signs', () => {
      assert.strictEqual(calculateNumber('DIVIDE', -7.0, 4.0), -3.5);
    });
    ...
    it('equal positive numbers', () => {
      assert.strictEqual(calculateNumber('DIVIDE', 4.0, 2.0), 1);
    });
